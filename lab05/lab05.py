...
def berry_finder(t):
    ...
    # return berry_finder([i for i in branches(t)])
    for i in branches(t):##遍历所有的分枝
        if berry_finder(i):
            return True
...
def sprout_leaves(t, leaves):
    ...
    if is_leaf(t):
        ...
        return tree(label(t),[sprout_leaves(id,leaves) for id in branches(t)])
